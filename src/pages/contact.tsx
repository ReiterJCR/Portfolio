...
const Contact: NextPage = () => {
  return (
    <>
      <Head>
        <title>Contact</title>
        <meta name="description" content="Contact Joel Reiter" />
      </Head>
      
      <Layout>
        <section className="min-h-screen bg-navy-900 flex flex-col justify-center items-center px-6 py-20">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Get in Touch</h2>
            <p className="text-navy-300 text-lg md:text-xl mb-12">
              Looking for a Software Developer? Feel free to reach out via email or connect through my social profiles.
            </p>
