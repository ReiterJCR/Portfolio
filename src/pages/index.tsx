      ...
      <Layout>
        <section className="min-h-screen flex flex-col justify-center items-center bg-navy-900 text-white px-6 py-16 relative">
          ...
          <button 
            ...
            className="absolute bottom-50 left-1/2 transform -translate-x-1/2 animate-bounce focus:outline-none"
        ...
        <div className="container mx-auto px-6">
            ...
            {/* Centered "See Projects" Button */}
            <div className="flex justify-center mt-12">
            <Link
                href="/projects"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg transition-all duration-300 text-lg font-medium hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
                See Projects
            </Link>
            </div>
